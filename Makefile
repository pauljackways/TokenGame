...
game.o: game.c ../../drivers/avr/system.h button.h led.h attack.h startup.h spin.h
	$(CC) -c $(CFLAGS) $< -o $@
...
spin.o: spin.c ../../drivers/avr/system.h spin.h
	$(CC) -c $(CFLAGS) $< -o $@


# Link: create ELF output file from object files.
game.out: game.o pio.o system.o button.o led.o attack.o startup.o spin.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
